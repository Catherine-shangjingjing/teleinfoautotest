...
# FROM: testcases/prefixmanager/ent-prefix-alloc-pageQuery-1.yml


from httprunner import HttpRunner, Config, Step, RunRequest, RunTestCase


class TestCaseEntPrefixAllocPagequery1(HttpRunner):
    ...
    teststeps = [
        Step(
            ...
            .assert_equal("body.data.content[0].entPrefix", "$randomPrefix")
        ),
    ]


if __name__ == "__main__":
    TestCaseEntPrefixAllocPagequery1().test_start()
