...
# FROM: testcases/prefixmanager/ent-prefix-manage-pageQuery-config.yml


from httprunner import HttpRunner, Config, Step, RunRequest, RunTestCase


class TestCaseEntPrefixManagePagequeryConfig(HttpRunner):
...
if __name__ == "__main__":
    TestCaseEntPrefixManagePagequeryConfig().test_start()
