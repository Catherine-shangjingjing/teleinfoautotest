...
# FROM: testcases/proxyAudit/proxyauditReject.yml


from httprunner import HttpRunner, Config, Step, RunRequest, RunTestCase


class TestCaseProxyauditreject(HttpRunner):

    config = Config("托管审核驳回").base_url("${ENV(HOST)}").verify(False)

    teststeps = [
        Step(
            RunRequest("/api/proxyserver/prefix/audit/save")
...
if __name__ == "__main__":
    TestCaseProxyauditreject().test_start()
