...
# FROM: testcases/handle/templateCreate_admin.yml


from httprunner import HttpRunner, Config, Step, RunRequest, RunTestCase


class TestCaseTemplatecreateAdmin(HttpRunner):
    ...
    teststeps = [
        Step(
            RunRequest("数据模板创建")
            .setup_hook("${setup_hook_example1()}")
...
if __name__ == "__main__":
    TestCaseTemplatecreateAdmin().test_start()
