...
# FROM: testcases/handle/handleCreate.yml


from httprunner import HttpRunner, Config, Step, RunRequest, RunTestCase


class TestCaseHandlecreate(HttpRunner):

    config = Config("标识注册").base_url("${ENV(HOST)}").verify(False)
...
if __name__ == "__main__":
    TestCaseHandlecreate().test_start()
