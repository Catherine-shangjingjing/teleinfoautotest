...
# FROM: testcases/prefixAudit/audit/v3-ent-audit-save-entprefix.yml


from httprunner import HttpRunner, Config, Step, RunRequest, RunTestCase


class TestCaseV3EntAuditSaveEntprefix(HttpRunner):
...
if __name__ == "__main__":
    TestCaseV3EntAuditSaveEntprefix().test_start()
