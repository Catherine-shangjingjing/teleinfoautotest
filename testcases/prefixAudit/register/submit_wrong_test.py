...
# FROM: testcases/prefixAudit/register/submit_wrong.yml


from httprunner import HttpRunner, Config, Step, RunRequest, RunTestCase


class TestCaseSubmitWrong(HttpRunner):
    ...
    teststeps = [
        Step(
            ...
            .assert_equal("body.status", -2)
            .assert_equal("body.message", "联系人手机号不合法")
        ),
    ]


if __name__ == "__main__":
    TestCaseSubmitWrong().test_start()
