...
# FROM: testcases/prefixAlloc/ent-prefix-alloc-savePrefix.yml


from httprunner import HttpRunner, Config, Step, RunRequest, RunTestCase


class TestCaseEntPrefixAllocSaveprefix(HttpRunner):
        ...
        Step(
            ...
            .with_params(
                **{
                    ...
                    "pendingPrefix": "$pendingPrefixCondition",
...
if __name__ == "__main__":
    TestCaseEntPrefixAllocSaveprefix().test_start()
