...
# FROM: testcases/entapply/store_first_update.yml


from httprunner import HttpRunner, Config, Step, RunRequest, RunTestCase


class TestCaseStoreFirstUpdate(HttpRunner):

    config = (
        Config("企业保存注册基本信息")
        .variables(
            **{"companyCode": "${get_username()}", "orgName": "${get_username()}"}
        )
        .base_url("${ENV(HOST)}")
        .verify(False)
    )
...
if __name__ == "__main__":
    TestCaseStoreFirstUpdate().test_start()
