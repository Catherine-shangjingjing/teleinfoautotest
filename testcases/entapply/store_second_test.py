...
# FROM: testcases/entapply/store_second.yml
...
class TestCaseStoreSecond(HttpRunner):
    ...
    config = (
        ...
        .variables(**{"updateAddr": "暂存之后的部署地址"})
        .base_url("${ENV(HOST)}")
        .verify(False)
    )
    ...
    teststeps = [
        Step(
            RunRequest("暂存企业注册第二步提交信息")
            .post("/api/v3/entApply/registerManageInfo/storage")
            .with_headers(
                **{
