...
# FROM: testsuites/prefixAudit/prefixAudit.yaml
...
class TestCasePrefixaudit(HttpRunner):
    ...
    teststeps = [
        ...
        Step(
            ...
            .export(*["prefixId", "entNameCn", "entPrefix", "proxyState", "userId"])
        ),
    ]


if __name__ == "__main__":
    TestCasePrefixaudit().test_start()
