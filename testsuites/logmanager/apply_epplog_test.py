...
# FROM: testsuites/logmanager/apply_epplog.yml
...
from testcases.logmanager.epplog_test import TestCaseEpplog as Epplog


class TestCaseApplyEpplog(HttpRunner):
    ...
    teststeps = [
        ...
        Step(
            ...
            .export(*["proxyState", "prefixId", "entNameCn", "userId", "entPrefix"])
        ),
        Step(RunTestCase("登录-企业").call(LoginEnt).export(*["entSession"])),
        Step(
            RunTestCase("获取申请id")
        ...
        Step(RunTestCase("查询epp日志").call(Epplog)),
    ]


if __name__ == "__main__":
    TestCaseApplyEpplog().test_start()
