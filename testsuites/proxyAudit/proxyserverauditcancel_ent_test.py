...
# FROM: testsuites/proxyAudit/proxyserverauditcancel_ent.yml
...
from testcases.proxyAudit.entproxyauditlist_test import (
    TestCaseEntproxyauditlist as Entproxyauditlist,
)


class TestCaseProxyserverauditcancelEnt(HttpRunner):
    ...
    teststeps = [
        ...
        Step(RunTestCase("企业用户登录").call(LoginEnt).export(*["entSession"])),
        Step(RunTestCase("企业登录系统，查看托管配置信息").call(Entproxyauditlist)),
    ]


if __name__ == "__main__":
    TestCaseProxyserverauditcancelEnt().test_start()
