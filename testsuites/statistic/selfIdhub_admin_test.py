...
# FROM: testsuites/statistic/selfIdhub-admin.yaml
...
class TestCaseSelfidhubAdmin(HttpRunner):

    config = (
        Config("idhub标识注册用例集-admin-30,31")
        .variables(
            **{
                "email": "${get_email()}",
                "mobile": "${get_mobile()}",
    ...
    teststeps = [
        ...
        Step(
            ...
            .export(*["entPrefix", "prefixId", "userId", "entNameCn"])
        ),
        ...
        Step(RunTestCase("首页统计查询-after").call(Indexstatistics1)),
    ]


if __name__ == "__main__":
    TestCaseSelfidhubAdmin().test_start()
