...
# FROM: testsuites/statistic/handle_stocknum_registernum.yml
...
from testcases.statistics.indexstatistics_check_identityNum_stockNum_test import (
    TestCaseIndexstatisticsCheckIdentitynumStocknum as IndexstatisticsCheckIdentitynumStocknum,
)


class TestCaseHandleStocknumRegisternum(HttpRunner):
    ...
    config = (
        ...
        .variables(
            **{
                ...
                "handle": "$prefix/89890${get_random_param(1,10000,1)}",
    ...
    teststeps = [
        ...
        Step(RunTestCase("登录-企业").call(LoginAdmin).export(*["adminSession"])),
        Step(RunTestCase("标识注册").call(Handlecreate)),
        Step(RunTestCase("删除标识").call(Handledelete)),
        Step(RunTestCase("登录-管理员").call(LoginAdmin).export(*["adminSession"])),
        Step(
            RunTestCase("企业申请中统计")
        ...
        Step(RunTestCase("标识注册").call(Handlecreate)),
        Step(RunTestCase("标识注册统计").call(IndexstatisticsCheckIdentitynumStocknum)),
    ]


if __name__ == "__main__":
    TestCaseHandleStocknumRegisternum().test_start()
