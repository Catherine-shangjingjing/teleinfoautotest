...
# FROM: testsuites/statistic/datamanager_biaoshiStatistic_parse.yml
...
from testcases.statistics.handleStathandleRegAnaStat_2_test import (
    TestCaseHandlestathandlereganastat2 as Handlestathandlereganastat2,
)


class TestCaseDatamanagerBiaoshistatisticParse(HttpRunner):

    config = (
        Config("管理员用户数据管理统计解析量")
        .variables(
            **{
    ...
    teststeps = [
        ...
        Step(RunTestCase("管理员用户数据管理统计解析量").call(Handlestathandlereganastat2)),
    ]


if __name__ == "__main__":
    TestCaseDatamanagerBiaoshistatisticParse().test_start()
