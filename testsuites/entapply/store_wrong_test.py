...
# FROM: testsuites/entapply/store_wrong.yml
...
from testcases.entapply.store_wrong_test import TestCaseStoreWrong as StoreWrong
...
class TestCaseStoreWrong(HttpRunner):
    ...
    teststeps = [
        ...
        Step(RunTestCase("企业保存注册错误基本信息").call(StoreWrong)),
    ]
