...
# FROM: testsuites/handle/test_handle_update_delete.yml
...
from testcases.handle.handleUpdate_ent_test import (
    TestCaseHandleupdateEnt as HandleupdateEnt,
)

from testcases.handle.handleDelete_ent_test import (
    TestCaseHandledeleteEnt as HandledeleteEnt,
)


class TestCaseTestHandleUpdateDelete(HttpRunner):
    ...
    teststeps = [
        ...
        Step(
            ...
            .export(*["prefixId", "proxyState", "entNameCn", "userId", "entPrefix"])
        ),
        ...
        Step(RunTestCase("标识修改").call(HandleupdateEnt)),
        Step(RunTestCase("标识删除").call(HandledeleteEnt)),
    ]


if __name__ == "__main__":
    TestCaseTestHandleUpdateDelete().test_start()
