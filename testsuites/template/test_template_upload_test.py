...
# FROM: testsuites/template/test_template_upload.yml
...
class TestCaseTestTemplateUpload(HttpRunner):

    config = Config("数据模板申报").variables(
        **{
    ...
    teststeps = [
        ...
        Step(
            ...
            .export(*["proxyState", "entNameCn", "userId", "prefixId", "entPrefix"])
        ),
...
if __name__ == "__main__":
    TestCaseTestTemplateUpload().test_start()
