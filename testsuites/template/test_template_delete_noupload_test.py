...
# FROM: testsuites/template/test_template_delete_noupload.yml
...
class TestCaseTestTemplateDeleteNoupload(HttpRunner):
    ...
    teststeps = [
        ...
        Step(
            ...
            .export(*["userId", "proxyState", "entNameCn", "entPrefix", "prefixId"])
        ),
...
if __name__ == "__main__":
    TestCaseTestTemplateDeleteNoupload().test_start()
