...
# FROM: testsuites/template/test_template_download_excel.yml
...
from testcases.handle.handleExcelTemplateDownload_test import (
    TestCaseHandleexceltemplatedownload as Handleexceltemplatedownload,
)


class TestCaseTestTemplateDownloadExcel(HttpRunner):

    config = Config("excel下载").variables(
        **{
    ...
    teststeps = [
        ...
        Step(
            ...
            .export(*["userId", "prefixId", "entPrefix", "proxyState", "entNameCn"])
        ),
        ...
        Step(RunTestCase("excel模版下载").call(Handleexceltemplatedownload)),
    ]


if __name__ == "__main__":
    TestCaseTestTemplateDownloadExcel().test_start()
