...
# FROM: testsuites/template/test_template_delete.yml
...
from testcases.template.templateUpload_test import (
    TestCaseTemplateupload as Templateupload,
)

from testcases.template.templateCancle_test import (
    TestCaseTemplatecancle as Templatecancle,
)

from testcases.template.templateDelete_test import (
    TestCaseTemplatedelete as Templatedelete,
)


class TestCaseTestTemplateDelete(HttpRunner):

    config = Config("数据模板删除").variables(
        **{
    ...
    teststeps = [
        ...
        Step(
            ...
            .export(*["entPrefix", "userId", "prefixId", "entNameCn", "proxyState"])
        ),
        ...
        Step(RunTestCase("数据模板申报").call(Templateupload)),
        Step(RunTestCase("数据模板撤送").call(Templatecancle)),
        Step(RunTestCase("数据模板删除").call(Templatedelete)),
    ]


if __name__ == "__main__":
    TestCaseTestTemplateDelete().test_start()
